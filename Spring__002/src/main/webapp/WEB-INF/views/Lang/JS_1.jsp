			...
			<div class="sidebar-wrapper">
				<nav id="sidebar">
					...
					<ul class="list-unstyled components">
						...
						<li><a href="#JS" data-toggle="collapse"
							aria-expanded="false">JS</a>
							<nav>
								<ul class="collapse list-unstyled" id="JS">
									<li class="nav-item"><a class="nav-link" href="#section13">연산자</a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#section23">조건문</a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#section33">반복문</a>
									</li>
									<li class="nav-item dropdown"><a
										class="nav-link dropdown-toggle" href="#" id="navbardrop"
										data-toggle="dropdown"> Element </a>
										<div class="dropdown-menu">
											<a class="dropdown-item" href="#section413">Link 1</a> <a
												class="dropdown-item" href="#section423">Link 2</a>
										</div></li>
								</ul>
							</nav> <a href="ai_1.do">머신러닝</a> <a href="ai_2.do">딥러닝</a>
					</ul>
				</nav>
			</div>
		</div>
		...
		<div id="content">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="section13" class="container-fluid bg-secondary"
					...
					<div id="section23" class="container-fluid bg-secondary"
						style="padding-top: 70px; padding-bottom: 70px">
						<h1>조건문</h1>
						<div class="row">
							<div class="col-md-8"></div>
					...
					<div id="section33" class="container-fluid bg-secondary"
						style="padding-top: 70px; padding-bottom: 70px">
						<h1>반복문</h1>
						<div class="row">
					...
					<div id="section413" class="container-fluid bg-secondary"
						style="padding-top: 70px; padding-bottom: 70px">
						<h1>Elements Sub1</h1>
					...
					<div id="section423" class="container-fluid bg-secondary"
						style="padding-top: 70px; padding-bottom: 70px">
						<h1>Elements Sub2</h1>
						<p>Try to scroll this section and look at the navigation bar
							while scrolling! Try to scroll this section and look at the
