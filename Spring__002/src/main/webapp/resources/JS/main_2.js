const apiKey = 'AIzaSyDzJ2st8EwoIA7JP6AMcE6lGOyBEHLHqeU';
...
fetch(channelEndpoint)
    ...
    .then(data => {
        ...
        const playlistId = data.items[0].contentDetails.relatedPlaylists;
...
function requestPlaylist(playlistId) {
    const maxResults = 20;
    const playlistURL = `https://www.googleapis.com/youtube/v3/search?key=${apiKey}&channelId=${channelId}&part=snippet&maxResults=${maxResults}&q=${keyword}`;
